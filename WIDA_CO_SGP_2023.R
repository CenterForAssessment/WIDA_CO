################################################################################
###                                                                          ###
###    Calculate 2023 Student Growth Percentiles for Colorado WIDA/ACCESS    ###
###                                                                          ###
################################################################################
...
load("Data/WIDA_CO_Data_LONG_2023.Rdata")

###   Preserve basic CU/KU variables from previous analyses
setnames(WIDA_CO_SGP@Data,
        c("CATCH_UP_KEEP_UP_STATUS", "CUKU_BASELINE_ORIG"),
        c("CUKU_ORIG",
          "CUKU_BASELINE_ORIG") # Already named correctly (inadvertently) after 2022
)
...
WIDA_CO_SGP <-
    updateSGP(
        ...
        with_sgp_data_LONG = WIDA_CO_Data_LONG_2023,
...
###  Run combineSGP for Interim Target Levels (for both 2022 and 2023)
