#####################################################################################
###                                                                               ###
###   WIDA Colorado Learning Loss Analyses -- 2020 Baseline Growth Percentiles    ###
###                                                                               ###
#####################################################################################
...
load("Data/WIDA_CO_Baseline_Matrices.Rdata")
SGPstateData[["WIDA_CO"]][["Baseline_splineMatrix"]][["Coefficient_Matrices"]] <- WIDA_CO_Baseline_Matrices

#####
###   Run BASELINE SGP analysis - create new WIDA_CO_SGP object with historical data
#####

###   Temporarily set names of prior scores from sequential/cohort analyses
data.table::setnames(WIDA_CO_SGP_LONG_Data,
...
WIDA_CO_SGP <- abcSGP(
        sgp_object = WIDA_CO_SGP_LONG_Data,
...
data.table::setnames(WIDA_CO_SGP@Data,
